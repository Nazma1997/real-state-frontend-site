    ...
    <div className='lg:max-w-7xl lg:mx-auto px-4 lg:px-8'>
      <div className='lg:flex md:flex  justify-between my-10  '>
        <div className="flex  relative lg:w-8/12 md:w-8/12 w-11/12 mr-5">
          ...
          <p className="absolute top-0 right-0  mt-2 bg-sky-500  text-white px-5 py-1 rounded-lg">For Sale</p>
        ...
        <div className="flex relative lg:w-5/12 md:w-5/12  w-11/12 my-3 ">
          ...
          <p className="absolute top-0 right-0  mt-2 bg-sky-500  text-white px-5 py-1 rounded-lg">For Rent</p>
      ...
      <div className='lg:flex  md:flex   justify-between my-10 '>
        ...
        <div className="flex relative lg:w-8/12 md:w-8/12 w-11/12">
          ...
          <p className="absolute top-0 right-0  mt-2 bg-sky-500  text-white px-5 py-1 rounded-lg">For Buy</p>
