    ...
    <div>
      ...
      <div className='lg:flex   lg:max-w-7xl lg:mx-auto px-4 lg:px-8 lg:mt-36 md: mt-32 mt- 24 mb-16'>
        ...
        <div className='bg-slate-100 pt-44 px-10 rounded-lg'>
          ...
          <input type='email' className='lg:px-10  lg:py-2 lg:mx-14 md:mx-28 md:px-36 px-10 mt-16 bg-slate-100 my-5 border-b-2 border-sky-500 text-sky-500 outline-none ' placeholder='Email' /> <br />
          <input type='password' className='lg:px-10  lg:py-2 lg:mx-14 md:mx-28 md:px-36 mt-16 px-10 bg-slate-100 my-5 border-b-2 border-sky-500 text-sky-500 outline-none ' placeholder='Password' /> <br />

          <button className=' bg-sky-500 text-white px-16 py-3 rounded-full hover:bg-black hover:text-white	font-semibold	lg:mx-24 mx-8 mt-24 md:mx-56 my-5'>Login</button>
        </div>
